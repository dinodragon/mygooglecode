...
// DrawControlDlg.cpp : 实现文件
//

#include "stdafx.h"
#include "DrawControl.h"
#include "DrawControlDlg.h"
...
CDrawControlDlg::CDrawControlDlg(CWnd* pParent /*=NULL*/)
...
// CDrawControlDlg 消息处理程序

BOOL CDrawControlDlg::OnInitDialog()
{
...
void CDrawControlDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
//显示。
HCURSOR CDrawControlDlg::OnQueryDragIcon()
{
